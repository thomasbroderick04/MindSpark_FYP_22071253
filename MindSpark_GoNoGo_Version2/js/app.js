...
(() => {
  ...
  document.addEventListener("DOMContentLoaded", () => {
    ...
    switch (file) {
      ...
      case "GoNoGoOfficialPage2.html": // These are 'No-Go' pages.
      case "GoNoGoVocalOfficial2Page.html":
        onStimulusPage(true);
        break;

      case "GoNoGoOfficialPage4.html": // These are 'Go' pages.
